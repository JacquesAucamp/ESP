...
void LCD_SetupTimeAxes(void)
{
	...
	//Label every 1ms
	BSP_LCD_DisplayChar(55,18,0x30);
	BSP_LCD_DisplayStringAt(75,8,(uint8_t *)"25",LEFT_MODE);
	BSP_LCD_DisplayStringAt(79.44,20,(uint8_t *)"|",LEFT_MODE);
	BSP_LCD_DisplayStringAt(99,8,(uint8_t *)"50",LEFT_MODE);
	BSP_LCD_DisplayStringAt(103.88,20,(uint8_t *)"|",LEFT_MODE);
	BSP_LCD_DisplayStringAt(124,8,(uint8_t *)"75",LEFT_MODE);
	BSP_LCD_DisplayStringAt(128.32,20,(uint8_t *)"|",LEFT_MODE);
	BSP_LCD_DisplayStringAt(145,8,(uint8_t *)"100",LEFT_MODE);
	BSP_LCD_DisplayStringAt(152.76,20,(uint8_t *)"|",LEFT_MODE);
	BSP_LCD_DisplayStringAt(170,8,(uint8_t *)"125",LEFT_MODE);
	BSP_LCD_DisplayStringAt(177.2,20,(uint8_t *)"|",LEFT_MODE);
	BSP_LCD_DisplayStringAt(195,8,(uint8_t *)"150",LEFT_MODE);
	BSP_LCD_DisplayStringAt(201.64,20,(uint8_t *)"|",LEFT_MODE);
	BSP_LCD_DisplayStringAt(219,8,(uint8_t *)"175",LEFT_MODE);
	BSP_LCD_DisplayStringAt(226.08,20,(uint8_t *)"|",LEFT_MODE);
	BSP_LCD_DisplayStringAt(244,8,(uint8_t *)"225",LEFT_MODE);
	BSP_LCD_DisplayStringAt(250.52,20,(uint8_t *)"|",LEFT_MODE);
	BSP_LCD_DisplayStringAt(267,8,(uint8_t *)"250",LEFT_MODE);
	BSP_LCD_DisplayStringAt(274.96,20,(uint8_t *)"|",LEFT_MODE);
	BSP_LCD_DisplayStringAt(300,8,(uint8_t *)"275",LEFT_MODE);
